...
fun DeleteDialog(
    ...
    name: String,
    files: List<String>,
    @androidx.annotation.StringRes deleteFilesLabelRes: Int = R.string.stashapp_actions_delete_file,
    initialDeleteFiles: Boolean = false,
    initialDeleteGenerated: Boolean = true,
    focusDeleteButton: Boolean = false,
) {
    var deleteGenerated by remember { mutableStateOf(initialDeleteGenerated) }
    var deleteFiles by remember { mutableStateOf(initialDeleteFiles) }

    val cancelFocusRequester = remember { FocusRequester() }
    val deleteFocusRequester = remember { FocusRequester() }
    LaunchedEffect(Unit) {
        if (focusDeleteButton) deleteFocusRequester.tryRequestFocus() else cancelFocusRequester.tryRequestFocus()
    }
    ...
    Dialog(
        ...
        LazyColumn(
            ...
            item {
                SwitchWithLabel(
                    label = stringResource(deleteFilesLabelRes),
                    checked = deleteFiles,
                    ...
                    Button(
                        ...
                        colors =
                            ButtonDefaults.colors(
                                ...
                                // Without these the focused container falls back to a light default,
                                // leaving the label unreadable while the button is selected
                        ...
                        Text(
                            ...
                            // Set explicitly because the non-TV Button ignores the colors above
                            color =
                                if (deleteFocused) {
